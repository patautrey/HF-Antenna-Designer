/* ============================================================
   HF Antenna Designer — Sloper Engine
...
export default class SloperEngine extends BaseEngine {
    ...
    buildGeometry() {
        ...
        for (let i = 0; i < segments; i++) {
            ...
            const x1 = f1 * totalLength;
            const x2 = f2 * totalLength;

            const z1 = topHeight - f1 * (topHeight - bottomHeight);
            const z2 = topHeight - f2 * (topHeight - bottomHeight);
        ...
        const feedSegment = Math.floor(segments * 0.1); // feed near top
